...
export default function RefundPolicyPage() {
  return (
    <LegalPage
      ...
      intro="We want you to be happy with your purchase. This policy explains how returns, exchanges, and refunds work at Cartebay."
    >
      ...
      <LegalSection heading="2. How to Start a Return">
        <ol className="[&>li]:ml-5 [&>li]:list-decimal">
          ...
          <li>Contact us at <a href="mailto:returns@cartebay.com">returns@cartebay.com</a> with your order number and the item(s) you&apos;d like to return.</li>
      ...
      <LegalSection heading="4. Damaged, Defective, or Incorrect Items">
        <p>If an item arrives damaged, defective, or different from what you ordered, contact us within 7 days of delivery at <a href="mailto:returns@cartebay.com">returns@cartebay.com</a> with photos of the issue. We&apos;ll arrange a full refund or free replacement — no return shipping cost to you, and no restocking fee.</p>
      </LegalSection>

      <LegalSection heading="5. Items Fulfilled Through Our Supplier Network">
        <p>Some items on Cartebay are shipped directly from our supplier network rather than our own warehouse (this is noted on the product page). Returns for these items follow the same 30-day window and process above, but may take a few extra days to process since the return is coordinated with the supplier. Damaged, defective, or lost supplier-fulfilled items are covered the same way as item 4 above.</p>
      </LegalSection>
      ...
      <LegalSection heading="8. Questions">
        <p>Reach our support team any time at <a href="mailto:returns@cartebay.com">returns@cartebay.com</a>, or visit our <Link href="/help">Contact Information</Link> page.</p>
      </LegalSection>
    </LegalPage>
  );
}

...
export default function PrivacyPolicyPage() {
  return (
    <LegalPage
      ...
      intro="This Privacy Policy explains what personal information Cartebay collects, how we use it, and the choices and rights you have. It applies to cartebay.com and any Cartebay account, order, or communication with us."
    >
      <LegalSection heading="1. Information We Collect">
        ...
        <p><strong>Payment information.</strong> Card numbers and other payment details are entered directly into Stripe, our payment processor, and never pass through or get stored on Cartebay&apos;s own servers. We retain only a payment confirmation and the last four digits of your card for your order history.</p>
      ...
      <LegalSection heading="3. Who We Share Information With">
        ...
        <ul>
          ...
          <li><strong>Order fulfillment</strong> — for products shipped by Cartebay directly, our carriers (e.g. UPS, USPS); for products dropshipped through our supplier network, the relevant supplier (e.g. CJdropshipping), who receives the shipping information needed to fulfill and ship your order</li>
          <li><strong>Email delivery</strong> — SendGrid, to deliver order confirmations and account emails</li>
          <li><strong>Legal &amp; safety</strong> — when required to comply with law, enforce our Terms of Service, or protect the rights, property, or safety of Cartebay, our customers, or others</li>
      ...
      <LegalSection id="your-privacy-rights" heading="6. Your Privacy Rights">
        <p>You can access, update, or delete much of your information directly from your <Link href="/account">account settings</Link>. You may also contact us at <a href="mailto:privacy@cartebay.com">privacy@cartebay.com</a> to request access to, correction of, or deletion of your personal information.</p>
        <p><strong>California residents (CCPA/CPRA).</strong> If you are a California resident, you have the right to know what personal information we collect, request deletion of it, correct inaccurate information, and opt out of the &ldquo;sale&rdquo; or &ldquo;sharing&rdquo; of personal information. Cartebay does not sell your personal information and does not share it for cross-context behavioral advertising. To exercise these rights, contact us at the email above; we will not discriminate against you for exercising them.</p>
      ...
      <LegalSection heading="7. Children&rsquo;s Privacy">
        <p>Cartebay is not directed to children under 13, and we do not knowingly collect personal information from children under 13. If you believe a child has provided us with personal information, please contact us and we will delete it.</p>
      </LegalSection>
      ...
      <LegalSection heading="10. Contact Us">
        <p>Questions about this policy or your personal information? Reach us at <a href="mailto:privacy@cartebay.com">privacy@cartebay.com</a> or visit our <Link href="/help">Contact Information</Link> page.</p>
      </LegalSection>
    </LegalPage>
  );
}

...
export default function TermsOfServicePage() {
  return (
    <LegalPage
      ...
      intro="These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of cartebay.com and any purchase you make from Cartebay. By creating an account, placing an order, or otherwise using our site, you agree to these Terms."
    >
      <LegalSection heading="1. Eligibility &amp; Accounts">
        <p>You must be at least 18 years old, or the age of majority in your state, to create an account and place an order. You&apos;re responsible for maintaining the confidentiality of your account credentials and for all activity under your account. Notify us immediately at <a href="mailto:support@cartebay.com">support@cartebay.com</a> if you suspect unauthorized use.</p>
      </LegalSection>
      ...
      <LegalSection heading="5. Product Reviews &amp; User Content">
        <p>If you submit a product review or other content to Cartebay, you grant us a non-exclusive, royalty-free, worldwide license to use, display, and reproduce that content in connection with operating and promoting our site. You&apos;re solely responsible for content you submit, and it must not be false, defamatory, infringing, or otherwise unlawful. We may remove any content at our discretion.</p>
      </LegalSection>

      <LegalSection heading="6. Prohibited Conduct">
        <p>You agree not to: use the site for any unlawful purpose; attempt to gain unauthorized access to our systems or another user&apos;s account; interfere with the site&apos;s operation or security; scrape or harvest data from the site without permission; or resell products purchased from Cartebay without our written consent.</p>
      </LegalSection>

      <LegalSection heading="7. Intellectual Property">
        <p>The Cartebay name, logo, site design, and all original content on cartebay.com are owned by Cartebay or its licensors and protected by copyright, trademark, and other laws. You may not use, copy, or reproduce them without our written permission, except as necessary to use the site for its intended purpose (e.g. browsing and purchasing products).</p>
      </LegalSection>
      ...
      <LegalSection heading="10. Limitation of Liability">
        <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, CARTEBAY WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE SITE OR PRODUCTS PURCHASED FROM US. OUR TOTAL LIABILITY FOR ANY CLAIM RELATED TO YOUR ORDER WILL NOT EXCEED THE AMOUNT YOU PAID FOR THE PRODUCT(S) GIVING RISE TO THE CLAIM. Some states do not allow these limitations, so they may not apply to you.</p>
      </LegalSection>

      <LegalSection heading="11. Dispute Resolution &amp; Arbitration">
        <p>We&apos;d like to resolve any concerns directly — please contact us first at <a href="mailto:support@cartebay.com">support@cartebay.com</a>. If a dispute can&apos;t be resolved informally, you and Cartebay agree that it will be resolved through binding individual arbitration rather than in court, except that either party may bring an individual claim in small claims court. You and Cartebay each waive the right to a jury trial and to participate in a class action. This arbitration provision does not apply where prohibited by law.</p>
      </LegalSection>
      ...
      <LegalSection heading="14. Contact">
        <p>Questions about these Terms? Contact us at <a href="mailto:support@cartebay.com">support@cartebay.com</a> or visit our <Link href="/help">Contact Information</Link> page.</p>
      </LegalSection>
    </LegalPage>
  );
}

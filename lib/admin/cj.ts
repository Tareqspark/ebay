import type { CjIntegrationSettings, CjShippingLine, CjSourcingRequest } from "@/lib/admin/cj-types";

// Hand-curated CJ integration reference data — mirrors
// scripts/cj-source.mjs (used by the data generator for orders/products)
// so the shipping-line catalog shown in the UI matches what was used to
// generate the mock cost/fee data.
export const CJ_SHIPPING_LINES: CjShippingLine[] = [
...
export const CJ_INTEGRATION_SETTINGS: CjIntegrationSettings = {
  connected: true,
...
export const CJ_SOURCING_REQUESTS: CjSourcingRequest[] = [
